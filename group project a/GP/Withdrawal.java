...
public class Withdrawal extends Transaction
{
   ...
   private int checkUserInput(){ // along side of the preset amount they can type in their amount, it creates flexibility
      int input = 0;
      do{
          ...
          catch(Exception e){ // just in case they type in floatting point it will not stop the program
              input = -1;
              screen.displayMessageLine( "\nIvalid selection. Try again." );
